...
public class Predictions {
    ...
    private void populate() {
      ...
      try {
         ...
         // Create and execute an SQL statement that OMOP fields data.
         String SQL = "SELECT * FROM [omop5_vocabulary].[dbo].[metadata_fields]";
         ...
         while (rs.next()) {
			...
			p.setFieldName(rs.getString(4));
		    p.setFieldDescription(rs.getString(7));
		    p.setFieldType(rs.getString(6));
		    p.setFieldRelation((int)rs.getFloat(9));			
		    addPrediction(p);						
         }
      }
